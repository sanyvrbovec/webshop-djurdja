  ...
  <div style="display:grid;gap:20px">
    ...
    <div class="acard">
      ...
      <table class="atable" style="font-size:13px">
        <tr><td>Verzija trgovine</td><td><strong><?= e(SHOP_VERSION) ?></strong><?php $us = Updater::status(); if ($us['newer']): ?> <a class="badge amber" href="<?= e(adminUrl('')) ?>">dostupna <?= e($us['latest']) ?> →</a><?php endif; ?></td></tr>
